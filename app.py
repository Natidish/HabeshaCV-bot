...
def run_bot_polling():
    ...
    # ማንኛውም thread (ከ main thread ውጪ) ራሱ የግድ የራሱ event loop ሊኖረው
    # ይገባል፤ Python ራሱ በራሱ ("implicit") loop አይፈጥርለትም። ስለዚህ እዚህ
    # ላይ በግልጽ አዲስ event loop እንፈጥራለን እና ለዚህ thread እናዘጋጃለን።
